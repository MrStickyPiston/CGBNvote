                      ...
                      <tr>
                        <td
                          ...
                          <div
                               ...
                               ><p>Je authenticatiecode voor CGBNvote is <strong>{{code}}</strong>.<br>De code vervalt over {{code_duration}} minuten. <br>Na de verkiezingen kun je de uitslag <a href="{{PAGE_URL}}/results">hier</a> bekijken.</p>
                            <br>
                          </div>
                        </td>
                      </tr>
